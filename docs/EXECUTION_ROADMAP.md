...
**Before starting any task, read the relevant sections from `LEGACY_CODEBASE_REFERENCE.txt`**
...
- Read `LEGACY_CODEBASE_REFERENCE.txt` lines 1924-1979 for exact `PromptSegment` definition
- Read `LEGACY_CODEBASE_REFERENCE.txt` lines 5089-5589 for usage examples in modules
...
**File:** Update `ContinuityModule.swift` or create `PipelineTypes.swift`
**Priority:** 🔴 CRITICAL
...
**📚 Reference Legacy Code:**
- Read `LEGACY_CODEBASE_REFERENCE.txt` lines 4432-4456 for exact `PipelineContext` definition
- Read `LEGACY_CODEBASE_REFERENCE.txt` lines 4458-4523 for `PipelineError` enum
...
**File:** `DirectorStudioCore.swift` or new `MockServices.swift`
**Priority:** 🔴 CRITICAL
...
### Task 1.4: Update RewordingModule.swift + VALIDATE
**File:** `RewordingModule.swift`
**Priority:** 🔴 CRITICAL
...
4. **VALIDATE:** Run `swiftc -parse DirectorStudioCore.swift RewordingModule.swift DataModels.swift PipelineTypes.swift MockServices.swift`
...
### Task 1.5: Update SegmentationModule.swift + VALIDATE
...
2. Update execute() signature to include PipelineContext
3. Fix compilation errors
4. **VALIDATE:** Run `swiftc -parse DirectorStudioCore.swift SegmentationModule.swift DataModels.swift PipelineTypes.swift MockServices.swift`
5. **VALIDATE:** Test instantiation
6. Mark module complete
...
### Task 1.6: Update StoryAnalysisModule.swift + VALIDATE
**File:** `StoryAnalysisModule.swift`
**Priority:** 🔴 CRITICAL
...
2. Update execute() signature to include PipelineContext
3. Fix compilation errors
4. **VALIDATE:** Run `swiftc -parse DirectorStudioCore.swift StoryAnalysisModule.swift DataModels.swift PipelineTypes.swift MockServices.swift`
5. **VALIDATE:** Test instantiation
6. Mark module complete
...
### Task 1.7: Update TaxonomyModule.swift + VALIDATE
**File:** `TaxonomyModule.swift`
**Priority:** 🔴 CRITICAL
...
2. Update execute() signature to include PipelineContext
3. Fix compilation errors
4. **VALIDATE:** Run `swiftc -parse DirectorStudioCore.swift TaxonomyModule.swift DataModels.swift PipelineTypes.swift MockServices.swift`
5. **VALIDATE:** Test instantiation
6. Mark module complete
...
### Task 1.8: Update ContinuityModule.swift + VALIDATE
**File:** `ContinuityModule.swift`
**Priority:** 🔴 CRITICAL
...
4. **VALIDATE:** Run `swiftc -parse DirectorStudioCore.swift ContinuityModule.swift DataModels.swift PipelineTypes.swift MockServices.swift`
5. **VALIDATE:** Test instantiation
6. Mark module complete
...
**Priority:** 🟡 HIGH
**Module Name:** `PipelineConfiguration`
...
**📚 Reference Legacy Code:**
- Read `LEGACY_CODEBASE_REFERENCE.txt` lines 3088-3242 for complete `PipelineConfig` implementation
...
**Priority:** 🟡 HIGH
**Module Name:** `PipelineOrchestrator`
...
**📚 Reference Legacy Code:**
- Read `LEGACY_CODEBASE_REFERENCE.txt` lines 3722-4372 for `PipelineManager` implementation
- Read `LEGACY_CODEBASE_REFERENCE.txt` lines 25012-25759 for alternative implementation
...
**Priority:** 🟡 HIGH
**Module Name:** `PipelineIntegrationTest`
...
**Priority:** 🟡 MEDIUM
**Module Name:** `PipelineDocumentation`
...
**Priority:** 🔴 HIGH
**Module Name:** `SecretsConfiguration`
...
**📚 Reference Legacy Code:**
- Read `LEGACY_CODEBASE_REFERENCE.txt` lines 9152-9273 for `DeepSeekService` implementation
- Read `LEGACY_CODEBASE_REFERENCE.txt` lines 8274-8283 for `AIServiceProtocol` definition
...
**Priority:** 🔴 HIGH
**Module Name:** `ImageGenerationService`
...
**📚 Reference Legacy Code:**
- Search `LEGACY_CODEBASE_REFERENCE.txt` for Pollo API implementation
...
**File:** `AIService.swift`
**Priority:** 🟡 MEDIUM
**Module Name:** `AIServiceRateLimiting`
...
**Files:** `RewordingModule.swift`, `StoryAnalysisModule.swift`
**Priority:** 🔴 HIGH
...
**Priority:** 🟡 MEDIUM
**Module Name:** `PersistenceController`
...
**File:** `PipelineOrchestrator.swift`
**Priority:** 🟡 MEDIUM
**Module Name:** `CreditsPipelineIntegration`
...
**Priority:** 🔴 HIGH
**Module Name:** `DeveloperDashboard`
...
**Priority:** 🟡 MEDIUM
**Module Name:** `CreditsDocumentation`
...
**File:** `SegmentationModule.swift`
**Priority:** 🔴 CRITICAL
**Module Name:** `SegmentationVideoUpdate`
...
**Priority:** 🔴 CRITICAL
**Module Name:** `VideoGenerationModule`
...
**📚 Reference Legacy Code:**
- Read `LEGACY_CODEBASE_REFERENCE.txt` lines 568-610 for video clip structure
- Read `LEGACY_CODEBASE_REFERENCE.txt` lines 1100-1353 for video generation patterns
- Read `LEGACY_CODEBASE_REFERENCE.txt` lines 2723-2830 for video events
...
**Priority:** 🔴 CRITICAL
**Module Name:** `VideoAssemblyModule`
...
**📚 Reference Legacy Code:**
- Read `LEGACY_CODEBASE_REFERENCE.txt` lines 1787-1960 for export patterns
...
**File:** `ContinuityModule.swift`
**Priority:** 🔴 CRITICAL
**Module Name:** `ContinuityVideoValidation`
...
**Priority:** 🟡 MEDIUM
**Module Name:** `VideoDocumentation`
...
**Priority:** 🟢 MEDIUM
**Module Name:** `LocalizationScaffolding`
...
**Priority:** 🔴 CRITICAL
**Module Name:** `SecurityDocumentation`
