...
public final class StoryAnalysisModule: ModuleProtocol {
    ...
    public func validate(input: StoryAnalysisInput) -> Bool {
...
public struct StoryAnalysisInput {
...
public struct StoryAnalysisOutput {
...
public struct StoryAnalysis: Codable {
...
public struct DialogueBlock: Codable {
...
public struct EmotionalBeat: Codable {
...
public struct StoryStructure: Codable {
...
public struct EntityRelationship: Codable {
