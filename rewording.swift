...
public struct RewordingInput {
    ...
    public enum RewordingType: String, CaseIterable, Identifiable {
...
public final class RewordingModule: ModuleProtocol {
    ...
    public func validate(input: RewordingInput) -> Bool {
    ...
    public func execute(input: RewordingInput) async throws -> RewordingOutput {
        ...
        let rewordedText = try await aiService.sendRequest(
